    ...
    <body >
      ...
      <div class="container-fluid my-2"> 
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <a href="{{ route('accueil_recruteurs') }}" alt="accueil jobs uac"><img src="{{ asset('img/uacjobs.png') }}" alt="logo jobs uac"  class="navbar-img"></a>
          </div>
      ...
      <nav class="navbar  navbar-expand-lg navbar-dark bg-green  " >
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <ul class="navbar-nav mx-auto">
           ...
           <li class="nav-item dropdown  active page-scroll">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
               <a class="dropdown-item" href="{{ route('actualites_recruteurs') }}">Actualités</a>
                <a class="dropdown-item" href=" {{ route('publications_recruteurs') }}">Publications</a>
                <a class="dropdown-item" href="{{ route('galerie_recruteurs') }}">Galerie</a>
          ...
          <li class="nav-item  ">
            <a class="nav-link text-white" href="{{ route('about_recruteur') }}">A propos</a>
          </li>
          <li class="nav-item dropdown ">
             ...
             Opportunités
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
               <a class="dropdown-item" href="{{ route('stage_recruteurs') }}">Stages</a>
                <a class="dropdown-item" href="{{ route('emploi_recruteurs') }}">Emploi</a>
          ...
          <li class="nav-item dropdown ">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="{{ route('trucs_astuces_recruteurs') }}">Trucs et astuces </a>
                <a class="dropdown-item" href="{{ route('podcast_recruteurs') }}">Podcast Employabilité</a>
                <a class="dropdown-item" href="{{ route('foire_recruteurs') }}">Foire aux questions</a>
              </div>
            </li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="{{route('contact_recruteur')}}">Contacter un conseiller emploi</a>
              <a class="dropdown-item" href="{{ route('newsletter_recruteurs') }}">Souscrivez aux alertes email</a>
          ...
          <li class="nav-item dropdown ">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
               <a class="dropdown-item" href="{{ route('entreprises_recruteurs') }}">Entreprises</a>
                <a class="dropdown-item" href="{{ route('institutions_recruteurs') }}">Institutions</a>
              ...
              <li class="nav-item dropdown ">
                  <a class="nav-link dropdown-toggle bg-red text-white" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    @guest {{route('login')}} @else <i class="fas fa-user-circle"></i> &nbsp {{ Auth::user()->name }} @endguest</a>
                  </a>
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      <a class="dropdown-item" href="{{ route('profil_recruteur') }}">Rechercher profil d'un étudiant</a>
