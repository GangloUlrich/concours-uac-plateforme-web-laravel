...
<div class="container  py-3 mb-3 ">
    ...
    <form class=""> 
        ...
        <input type="text" placeholder="rechercher dans les trucs et astuces" name="newsletter" class="form-control a-border bg-white border-success " required>
...
<div class="container  py-2 mb-5">
    ...
    @foreach($astuces as $astuce)
            <div class="  card a-border card-fixed shadow ">
                ...
                <a href="{{ route('show_astuces_etudiants',['n'=>$astuce->id_astuce]) }}" class="btn btn-success a-border">Lire l'article</a>
                </div>
            </div>
        @endforeach
