    ...
    <body >
      ...
      <div class="container-fluid my-2"> 
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <a href="{{ route('accueil') }}" alt="accueil jobs uac"><img src="{{ asset('img/uacjobs.png') }}" alt="logo jobs uac"  class="navbar-img"></a>
          </div>
      ...
      <nav class="navbar  navbar-expand-lg navbar-dark bg-green  " >
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <ul class="navbar-nav mx-auto">
           ...
           <li class="nav-item dropdown  active page-scroll">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
               <a class="dropdown-item" href="{{ route('actualites') }}">Actualités</a>
          ...
          <li class="nav-item  ">
            <a class="nav-link text-light" href="{{ route('about') }}">A propos</a>
          </li>
          <li class="nav-item dropdown ">
             ...
             Opportunités
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
               <a class="dropdown-item" href="{{ route('stage') }}">Stages</a>
                <a class="dropdown-item" href="{{ route('emploi') }}">Emploi</a>
          ...
          <li class="nav-item dropdown ">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="{{ route('trucs_astuces') }}">Trucs et astuces </a>
                <a class="dropdown-item" href="{{ route('podcast') }}">Podcast Employabilité</a>
                <a class="dropdown-item" href="{{ route('foire') }}">Foire aux questions</a>
              </div>
            </li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="{{route('contact')}}">Contacter un conseiller emploi</a>
              <a class="dropdown-item" href="{{ route('newsletter') }}">Souscrivez aux alertes email</a>
          ...
          <li class="nav-item dropdown ">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
               <a class="dropdown-item" href="{{ route('entreprises') }}">Entreprises</a>
                <a class="dropdown-item" href="{{ route('institutions') }}">Institutions</a>
            ...
            <li class="nav-item  ">
              <a class="nav-link bg-red text-light" href="{{ route('login') }}">Se connecter</a>
            </li>
      ...
      <footer class="container-fluid bg-black text-light text-center ">
        <div class="row pt-3 mb-4"> 
          ...
          <div class="col-sm-12 col-md-3 text-center">
            ...
            <div class="">
              <a class="text-light" href="#" alt="linkedin"><i class="fab fa-linkedin fa-2x"></i></a>
              <a class="text-light" href="#" alt="twitter"><i class="fab fa-twitter-square fa-2x "></i></a>
              <a class="text-light" href="#" alt="facebook"><i class="fab fa-facebook-square fa-2x"></i></a>
              <a class="text-light" href="#" alt="rss"><i class="fas fa-rss-square fa-2x "></i></a>
