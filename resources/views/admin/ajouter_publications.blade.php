@extends('admin.app')
@section('title', 'nouvelle_publication')
@section('content')
    <div class="wrapper ">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Ajouter une nouvelle publication </a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ route('ajouter_publications') }}"
