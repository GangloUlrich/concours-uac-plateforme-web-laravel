                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="titre" id="titre" value="{{$actualite->titre_actualite}}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="input-group no-border">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="5" name="contenu" id="contenu">{{$actualite->contenu_actualite}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
