            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Publications</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header card-header-success">
                            ...
                            <p class="card-category">Toutes les publications de la plus récente à la plus ancienne</p>
                            <a href="{{route('add_publications')}}" type="button" class="btn btn-outline-success btn-round btn-just-icon align-content-end" title="Ajouter">
                        ...
                        <div class="card-body">
                            ...
                            <div class="container card-columns">
                                @foreach($publications as $publication)
                                        ...
                                        <div class="card ">
                                            <img src="..{{$publication->image_publication}}" class="card-img-top" alt="...">
                                            <div class="card-body">
                                                <h4 class="card-title">{{$publication->titre_publication}}</h4>
                                                <p class="card-category">{{$publication->contenu_publication}}</p>
                                            </div>
                                            
                                            <div class="card-footer text-center">
                                            
                                                <a href="#"  class="btn btn-warning  btn-sm"><i class="material-icons ">date_range</i>{{$publication->created_at}} </a>
                                               
                                                    <a href="{{route('edit_publications', ['n' => $publication->id_publication])}}" type="button" rel="tooltip" title="Modifier" class="btn btn-success btn-sm">
                                                        <i class="material-icons ">edit</i>
                                                    </a>
                                                    <a href="{{route('delete_publications', ['n' => $publication->id_publication])}}" type="button" rel="tooltip" title="Supprimer" class="btn  btn-danger btn-sm ">
