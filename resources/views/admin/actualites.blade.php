            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Actualités</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header card-header-success">
                            ...
                            <p class="card-category">Toutes les actualités de la plus récente à la plus ancienne</p>
                            <a href="{{route('add_actualites')}}" type="button" class="btn btn-outline-success btn-round btn-just-icon align-content-end" title="Ajouter">
                        ...
                        <div class="card-body">
                            ...
                            @foreach($actualites as $actualite)
                                    ...
                                    <div class="card">
                                        <img src="..{{$actualite->image_actualite}}" class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <h4 class="card-title">{{$actualite->titre_actualite}}</h4>
                                            <p class="card-category">{{$actualite->contenu_actualite}}</p>
                                        </div>
                                        <div class="card-footer text-center">
                                            
                                                <a href="#"  class="btn btn-warning  btn-sm"><i class="material-icons ">date_range</i> {{$actualite->created_at}}</a>
                                               
                                                    <a href="{{route('edit_actualites', ['n' => $actualite->id_actualite])}}" type="button" rel="tooltip" title="Modifier" class="btn btn-success btn-sm">
                                                        <i class="material-icons ">edit</i>
                                                    </a>
                                                    <a href="{{route('delete_actualites', ['n' => $actualite->id_actualite])}}" type="button" rel="tooltip" title="Supprimer" class="btn  btn-danger btn-sm ">
