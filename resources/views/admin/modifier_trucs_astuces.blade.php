                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{route('update_trucs_astuces')}}" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <input type="hidden" name="id_astuce" value="{{$astuce->id_astuce}}">

                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating" for="idtitre">Titre</label>
                                                    <input type="text" class="form-control" name="titre" id="titre" value="{{$astuce->titre_astuce}}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="input-group no-border">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating" for="idcontenu">Contenu</label>
                                                        <textarea class="form-control" rows="5" name="contenu" id="contenu">{{$astuce->contenu_astuce}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
