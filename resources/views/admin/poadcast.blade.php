                    ...
                    <div class="card">
                        <div class="card-header card-header-success">
                            ...
                            <div class="offset-3 col-md-6">
                                <form class="navbar-form" method="post" action="{{route('ajouter_poadcasts')}}">
                                    {{csrf_field()}}
                                    <div class="input-group no-border">
                                        <input type="text" name="titre" value="" class="form-control text-white" placeholder="Titre de l'émission">
                                    </div><br>
                                    <div class="input-group no-border">
                                        <input type="text" name="lien" value="" class="form-control text-white" placeholder="Lien de l'émission">
                                        <button type="submit" class="btn btn-white btn-round btn-just-icon">
