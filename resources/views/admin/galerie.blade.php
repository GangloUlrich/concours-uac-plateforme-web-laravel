            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Galerie</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header card-header-success">
                            ...
                            <p class="card-category">Partage de photos et vidéos</p>
                            <div class="offset-3 col-md-6">
                                <form class="navbar-form" method="post" action="{{route('ajouter_photos')}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div class="input-group no-border">
                                        <input type="text" name="description" value="" class="form-control text-white" placeholder="Description de l'image...">
                                    </div><br>
                                    <div class="input-group no-border">
                                        <input type="file" name="image" accept=".png, .jpg, .jpeg" id="image" class="form-control text-white">
                                        <button type="submit" class="btn btn-white btn-round btn-just-icon">
                        ...
                        <div class="card-body">
                            ...
                            @foreach($photos as $photo)
                                <div class="card">
                                    <img class="card-img-top" src="..{{$photo->lien_photo}}" alt="{{$photo->description_photo}}">
                                    <div class="card-body">
                                        <h4 class="card-title">{{$photo->description_photo}}</h4>
                                    </div>
                                     <div class="card-footer text-center">
                                            
                                        <a href="#"  class="btn btn-warning  btn-sm"><i class="material-icons ">date_range</i> {{$photo->created_at}}</a>
                                       
                                            <a href="{{route('edit_photos', ['n' => $photo->id_photo])}}"  type="button" rel="tooltip" title="Modifier" class="btn btn-success btn-sm">
                                                <i class="material-icons ">edit</i>
                                            </a>
                                            <a href="{{route('delete_photos', ['n' => $photo->id_photo])}}" type="button" rel="tooltip" title="Supprimer" class="btn  btn-danger btn-sm ">
