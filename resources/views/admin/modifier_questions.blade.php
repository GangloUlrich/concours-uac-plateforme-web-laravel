            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">FAQ</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header card-header-success">
                            <h4 class="card-title">Foire aux questions</h4>
                            <p class="card-category">Toutes les questions traitées de la plus récente à la plus ancienne</p><br>
                            <div class="offset-3 col-md-6">
                                <form class="navbar-form" method="post" action="{{route('update_questions')}}">
                                    {{csrf_field()}}
                                    <input type="hidden" name="id_question" value="{{$quiz->id_question}}">

                                    <div class="input-group no-border">
                                        <input type="text" name="question" value="{{$quiz->libelle}}" class="form-control text-white" placeholder="Modifier...">
                                        <button type="submit" class="btn btn-white btn-round btn-just-icon">
                                        ...
                                        @foreach($questions as $question)
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    <a href="#" type="button" rel="tooltip" title="Voir les reponses" class="btn btn-success btn-link btn-sm">
                                                        <i class="material-icons fas fa-eye"></i>
                                                    </a>
                                                    <a href="{{route('edit_questions', ['n' => $question->id_question])}}" type="button" rel="tooltip" title="Modifier" class="btn btn-warning btn-link btn-sm">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    <a href="{{route('delete_questions', ['n' => $question->id_question])}}" type="button" rel="tooltip" title="Supprimer" class="btn btn-danger btn-link btn-sm">
