                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{route('update_stages')}}">
                                        {{csrf_field()}}
                                        <input type="hidden" name="id_opportunites" value="{{$opportunites->id_opportunite}}">

                                        <input type="hidden" name="type" value="{{$opportunites->type}}">

                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating" for="idtitre">Intitulé</label>
                                                    <input type="text" class="form-control" name="titre" id="titre" value="{{$opportunites->titre_opportunite}}">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating" for="iddelai">Délai</label>
                                                    <input type="date" class="form-control" name="delai" id="delai" value="{{$opportunites->delai}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating" for="iddescription"> Description</label>
                                                        <textarea class="form-control" rows="5" name="description" id="description">{{$opportunites->description}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
