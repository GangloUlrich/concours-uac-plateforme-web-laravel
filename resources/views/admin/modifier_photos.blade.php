                    ...
                    <div class="card">
                        <div class="card-header card-header-success">
                            ...
                            <div class="offset-3 col-md-6">
                                <form class="navbar-form" method="post" action="{{route('update_photos')}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <input type="hidden" name="id_photo" value="{{$photo->id_photo}}">

                                    <div class="input-group no-border">
                                        <input type="text" name="description" value="{{$photo->description_photo}}" class="form-control text-white" placeholder="Description">
                                    </div><br>
                                    <div class="input-group no-border">
                                        <input type="file" name="image" accept=".png, .jpg, .jpeg" id="image" class="form-control text-white" value="{{$photo->lien_photo}}">
                                        <button type="submit" class="btn btn-white btn-round btn-just-icon">
                        ...
                        <div class="card-body">
                            @foreach($photos as $photo)
                                <div class="col-md-3">
                                    <img class="img-fluid img-thumbnail" src="..{{$photo->lien_photo}}" alt="{{$photo->description_photo}}">
                                    <a href="{{route('edit_photos', ['n' => $photo->id_photo])}}" type="button" rel="tooltip" title="Modifier" class="btn btn-warning btn-link btn-sm">
                                        <i class="material-icons">edit</i>
                                    </a>
                                    <a href="{{route('delete_photos', ['n' => $photo->id_photo])}}" type="button" rel="tooltip" title="Supprimer" class="btn btn-danger btn-link btn-sm">
