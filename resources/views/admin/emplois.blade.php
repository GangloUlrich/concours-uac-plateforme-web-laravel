            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Emplois</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header card-header-success">
                            <h4 class="card-title">Emplois</h4>
                            <p class="card-category">Toutes les offres d'emploi</p>
                            <a href="{{route('add_opportunites')}}" type="button" class="btn btn-outline-success btn-round btn-just-icon align-content-end" title="Ajouter">
                        ...
                        <div class="card-body">
                            ...
                            @foreach($emplois as $emploi)
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title">{{$emploi->titre_opportunite}}</h4>
                                            <p class="card-category">{{$emploi->description}}</p>
                                            <span class="text-left text-danger"> Delai:{{$emploi->delai}}</span>
                                        </div>
                                        <div class="card-footer px-3">
                                            
                                               
                                                    <a href="#" type="button" rel="tooltip" title="Voir plus" class=" btn btn-primary  btn-sm">
                                                        <i class="material-icons fas fa-eye"></i>
                                                    </a>
                                                    <a href="{{route('edit_stages', ['n' => $emploi->id_opportunite])}}" type="button" rel="tooltip" title="Modifier" class="btn btn-success  btn-sm">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    @if($emploi->activation == false)
                                                        <a href="{{route('activation_stages', ['n' => $emploi->id_opportunite])}}" type="button" rel="tooltip" title="Activer" class="btn btn-dark  btn-sm">
                                                            <i class="material-icons fas fa-lock"></i>
                                                        </a>
                                                    @else
                                                        <a href="{{route('activation_stages', ['n' => $emploi->id_opportunite])}}" type="button" rel="tooltip" title="Désactiver" class="btn btn-dark  btn-sm">
                                                            <i class="material-icons fas fa-unlock"></i>
                                                        </a>
                                                    @endif
                                                    <a href="{{route('delete_stages', ['n' => $emploi->id_opportunite])}}" type="button" rel="tooltip" title="Supprimer" class="btn btn-danger  btn-sm">
