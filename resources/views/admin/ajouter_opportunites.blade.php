@extends('admin.app')
@section('title','Ajouter Opportunités')
@section('content')
    <div class="wrapper ">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Opportunités</a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-success">
                                    <h4 class="card-title">Nouvelle Opportunité (Stage ou Emploi)</h4>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="{{route('ajouter_opportunites')}}" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <div class="row">
                                            <input type="hidden" name="id_recruteur" value="1">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <select class="form-control custom-select" id="active" name="active">
                                                        <option value="oui">Activer</option>
