                    ...
                    <div class="card">
                        <div class="card-header card-header-success">
                            ...
                            <div class="offset-3 col-md-6">
                                <form class="navbar-form" method="post" action="{{route('ajouter_questions')}}">
                                    {{csrf_field()}}
                                    <div class="input-group no-border">
                                        <input type="text" name="question" value="" class="form-control text-white" placeholder="Ajouter...">
                                        <button type="submit" class="btn btn-white btn-round btn-just-icon">
