                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{route('update_publications')}}" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="titre" id="titre" value="{{$publication->titre_publication}}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="input-group no-border">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="5" name="contenu" id="contenu">{{$publication->contenu_publication}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
