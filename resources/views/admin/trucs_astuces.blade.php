            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Trucs et Astuces</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header card-header-success">
                            <h4 class="card-title">Trucs et Astuces</h4>
                            <p class="card-category">Tous les trucs et astuces du plus récent au plus ancien</p>
                            <a href="{{route('add_trucs_astuces')}}" type="button" class="btn btn-outline-success btn-round btn-just-icon align-content-end" title="Ajouter">
                        ...
                        <div class="card-body">
                            ...
                            @foreach($astuces as $astuce)
                                    ...
                                    <div class="card ">
                                        <img src="..{{$astuce->image_astuce}}" class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <h4 class="card-title">{{$astuce->titre_astuce}}</h4>
                                            <p class="card-category">{{$astuce->contenu_astuce}}</p>
                                        </div>
                                        <div class="card-footer text-center">
                                          
                                        <a href="#"  class="btn btn-warning  btn-sm"><i class="material-icons">date_range</i> {{$astuce->created_at}}</a>
                                               
                                                    <a href="{{route('edit_trucs_astuces', ['n' => $astuce->id_astuce])}}" type="button" rel="tooltip" title="Modifier" class="btn btn-success  btn-sm">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    <a href="{{route('delete_trucs_astuces', ['n' => $astuce->id_astuce])}}" type="button" rel="tooltip" title="Supprimer" class="btn btn-danger  btn-sm">
