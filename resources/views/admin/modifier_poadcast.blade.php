@extends('admin.app')
@section('title','Poadcast Employabilité')
@section('content')
    <div class="wrapper ">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Poadcast Employabilité</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header card-header-success">
                            <h4 class="card-title">Poadcasts</h4>
                            <p class="card-category">Toutes les émissions </p><br>
                            <div class="offset-3 col-md-6">
                                <form class="navbar-form" method="post" action="{{route('update_poadcasts')}}">
                                    {{csrf_field()}}
                                    <input type="hidden" name="id_poadcast" value="{{$poadcast->id_poadcast}}">

                                    <div class="input-group no-border">
                                        <input type="text" name="titre" value="{{$poadcast->titre_poadcast}}" class="form-control text-white" placeholder="Titre de l'émission">
                                    </div><br>
                                    <div class="input-group no-border">
                                        <input type="text" name="lien" value="{{$poadcast->lien_poadcast}}" class="form-control text-white" placeholder="Lien de l'émission">
                                        <button type="submit" class="btn btn-white btn-round btn-just-icon">
                                            <i class="material-icons fas fa-plus-circle"></i>
                                            <div class="ripple-container"></div>
                                        </button>
                                    </div>
                                </form>
                                ...
                                <div class="tab-pane active" id="profile">
                                    <table class="table">
                                        ...
                                        @foreach($poadcasts as $poadcast)
                                            <tr>
                                                <td>{{$poadcast ->id_poadcast}}</td>
                                                <td>{{$poadcast ->titre_poadcast}}</td>
                                                <td>{{$poadcast ->lien_poadcast}}</td>
                                                <td class="td-actions text-right">
                                                    <a href="{{route('edit_poadcasts', ['n' => $poadcast->id_poadcast])}}" type="button" rel="tooltip" title="Modifier" class="btn btn-warning btn-link btn-sm">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    <a href="{{route('delete_poadcasts', ['n' => $poadcast->id_poadcast])}}" type="button" rel="tooltip" title="Supprimer" class="btn btn-danger btn-link btn-sm">
