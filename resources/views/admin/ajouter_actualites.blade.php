@extends('admin.app')
@section('title', 'ajouter_actualites')
@section('content')
    <div class="wrapper ">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;"><A>Ajouter Actualites</A></a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ route('ajouter_actualites') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group no-border">
                                                    <label class="bmd-label-floating" for="idtitre">Image</label>
