...
<div class="container  py-2 mb-5">
    <div class="card-columns  ">
        ...
        <div class="card a-border p-0 ">
          <img class="card-img-top" src="{{ asset('/img/vision-uac.jpg') }}" alt="galerie">
            <div class="card-body  p-2">
              <p class="card-title  font-weight-bold">Card title lorem ipsum dolor consectur iture perspicatis </p>
      ...
      <div class="card a-border p-0 ">
        <img class="card-img-top" src="{{ asset('/img/uac-map.jpg') }}" alt="galerie">
        <div class="card-body  p-2">
          <p class="card-title  font-weight-bold">Card title lorem ipsum dolor consectur iture perspicatis </p>
  ...
  <div class="card a-border p-0 ">
    <img class="card-img-top" src="{{ asset('/img/uac-etu.jpg') }}" alt="galerie">
    <div class="card-body  p-2">
      <p class="card-title  font-weight-bold">Card title lorem ipsum dolor consectur iture perspicatis </p>
...
<div class="card a-border p-0 ">
  <img class="card-img-top" src="{{ asset('/img/image2.jpg') }}" alt="galerie">
  <div class="card-body  p-2">
    <p class="card-title  font-weight-bold">Card title lorem ipsum dolor consectur iture perspicatis </p>
...
<div class="card a-border p-0 ">
  <img class="card-img-top" src="{{ asset('/img/light.jpg') }}" alt="galerie">
  <div class="card-body  p-2">
    <p class="card-title  font-weight-bold">Card title lorem ipsum dolor consectur iture perspicatis </p>
